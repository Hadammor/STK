...
export function HelpButton() {
  ...
  return (
    <button
      ...
      className="pointer-events-auto absolute right-4 flex h-14 w-14 items-center justify-center rounded-full border border-hair bg-white text-2xl font-semibold text-ink active:bg-surface"
